...
<body>
	<nav class="navbar">
		<div class="container-fluid">
			<img src="../images/burgerlogo.jpg" alt="Burger logo" width="100"
				height="100"> <a class="navbar-brand" href="welcome.php">Talent
				Burgers</a>
				...
				<div class="offcanvas-body">
					<ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
						<li class="nav-item"><a class="nav-link active"
							aria-current="page" href="welcome.php">Home</a></li>
    ...
    if(isset($_SESSION['email'])) {
      ...
      echo "Welcome to Talent Burgers";
    }
  ?></h1>
		...
		<tr>
			<td>
				...
				<br>From savory entrees to delectable desserts, we've got something to satisfy every craving.</p>
												<input id = "viewSubmit" type="submit" value="View Our Meals">
